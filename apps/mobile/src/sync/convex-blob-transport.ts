/**
 * convex-blob-transport.ts — BlobTransport backed by the Convex client (mobile).
 *
 * Mirrors apps/web/src/sync/convex-blob-transport.ts exactly.
 ...
 * `fetch` is a global in React Native — no polyfill needed.
 */
