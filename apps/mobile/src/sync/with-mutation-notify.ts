 ...
 * chokepoint and zero changes to the NativeStore mutators. All other methods
 * pass straight through to the underlying repo (same instance — value isolation
 * and outbox state are unchanged).
 */
