 ...
 *
 * Pure: no React, no DOM, no timers, no Date.now() — all injected by the caller.
 */
 ...
 * owns timers and browser event listeners; this seam is fully synchronous and
 * unit-testable without any browser globals.
 */
